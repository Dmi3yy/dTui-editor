/* dTui.editor Prism languages: bash, blade, json, markdown, php, scss, sql, typescript, yaml. Core prism.min.js already provides markup/html/xml, css and javascript. */
...
/* dTui.editor lightweight Blade grammar */
!function(e){if(e&&e.languages){var n=e.languages.php||{},a=e.languages.markup?e.languages.extend("markup",{}):{},i=e.languages.markup&&e.languages.markup.tag?e.languages.markup.tag.inside:{},r={"blade-comment":{pattern:/{{--[\s\S]*?--}}/,greedy:!0,alias:"comment"},"blade-php-block":{pattern:/@php[\s\S]*?@endphp/i,greedy:!0,inside:{directive:{pattern:/^@php|@endphp$/i,alias:"keyword"},rest:n}},"blade-echo":[{pattern:/\{!![\s\S]*?!!\}/,greedy:!0,inside:{delimiter:{pattern:/^\{!!|!!\}$/,alias:"punctuation"},rest:n}},{pattern:/\{\{[\s\S]*?\}\}/,greedy:!0,inside:{delimiter:{pattern:/^\{\{|\}\}$/,alias:"punctuation"},rest:n}}],"blade-directive":{pattern:/@[A-Za-z_][\w]*(?:[ \t]*\([^)]*\))?/,inside:{"directive-name":{pattern:/^@[A-Za-z_][\w]*/,alias:"keyword"},rest:n}},"blade-component":{pattern:/<\/?(?:x[-:\w.]*|livewire:[-:\w.]+)\b(?:\s+(?:[^<>]|"(?:\\.|[^\\"])*"|'(?:\\.|[^\\'])*')*)?\/?>/i,greedy:!0,alias:"tag",inside:i}};e.languages.blade={};Object.keys(r).forEach(function(n){e.languages.blade[n]=r[n]});Object.keys(a).forEach(function(n){e.languages.blade[n]||(e.languages.blade[n]=a[n])});e.languages["laravel-blade"]=e.languages.blade;e.languages.bladephp=e.languages.blade}}(Prism);
